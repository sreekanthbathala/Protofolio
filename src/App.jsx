...
const projects = [
  {
    ...
    description:
      "Built an end-to-end RAG pipeline using Llama 3.2 via Ollama. Features real-time Q&A chat and conversation history, running 100% locally.",
  ...
  },
  {
    ...
    description:
      "A full-stack MERN application with RESTful APIs to manage student and course records, featuring a clean and responsive UI.",
    tags: ["React", "Node.js", "Express", "MongoDB"],
    image:
      "https://images.unsplash.com/photo-1523050335392-9bc5675e7831?auto=format&fit=crop&q=80&w=800",
    link: "https://github.com/sreekanthbathala",
  },
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-accent selection:text-accent-foreground">
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-background/80 backdrop-blur-md border-b py-4" : "bg-transparent py-6"}`}
      >
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              <Badge
                variant="outline"
                className="mb-6 px-4 py-1 border-accent/50 text-accent uppercase tracking-[0.2em] text-[10px]"
              >
              ...
              <p className="max-w-2xl mx-auto text-muted-foreground text-lg md:text-xl font-light leading-relaxed mb-10">
                B.Tech CSE student specializing in Generative AI and RAG
                systems. Building intelligent applications that run locally and
                efficiently.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  <Button
                    size="lg"
                    className="rounded-full px-8 bg-accent hover:bg-accent/90 text-white shadow-[0_0_20px_rgba(242,125,38,0.3)] hover:shadow-[0_0_30px_rgba(242,125,38,0.5)] transition-all"
                  >
                ...
                >
                  <Button
                    size="lg"
                    variant="outline"
                    className="rounded-full px-8 border-white/20 hover:bg-white/10 backdrop-blur-sm"
                  >
                    Let's Talk
                  </Button>
                </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              >
                ...
                <div className="space-y-6 text-muted-foreground text-lg font-light leading-relaxed">
                  <p>
                    I'm Sreekanth Bathala, a B.Tech Computer Science student at
                    MITS with a deep interest in AI/ML and Generative AI. I
                    specialize in building Retrieval-Augmented Generation (RAG)
                    pipelines that leverage local LLMs for privacy and
                    efficiency.
                  </p>
                  <p>
                    Beyond AI, I'm a full-stack developer experienced in the
                    MERN stack. I enjoy bridging the gap between complex backend
                    logic and intuitive frontend experiences.
                  </p>
                </div>
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
              <div>
                <Badge
                  variant="outline"
                  className="mb-4 px-4 py-1 border-accent/50 text-accent uppercase tracking-widest text-[10px]"
                >
                  Projects
                </Badge>
              ...
              <Button
                variant="link"
                className="text-accent p-0 h-auto text-lg hover:no-underline group"
              >
                View GitHub{" "}
                      ...
                      <div className="flex gap-2 mb-6 flex-wrap">
                        {project.tags.map((tag) => (
                          <Badge
                            key={tag}
                            variant="secondary"
                            className="bg-white/10 text-white border-none text-[10px] uppercase tracking-wider font-medium px-3 py-1"
                          >
                            {tag}
                          </Badge>
                        ))}
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                {skills.map((skill) => (
                  ...
                  >
                    <Badge className="px-10 py-5 text-lg md:text-2xl font-display font-bold rounded-full bg-white/10 border-white/20 text-white hover:bg-accent hover:text-white hover:border-accent hover:scale-110 transition-all duration-300 cursor-default shadow-lg backdrop-blur-md">
                      {skill}
                    </Badge>
                  </motion.div>
                ))}
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-5xl mx-auto glass-card p-12 md:p-20 rounded-[3rem] text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground font-light mb-12 max-w-2xl mx-auto">
                Actively seeking AI/ML internship opportunities. Let's build
              ...
              <div className="mt-20 pt-20 border-t border-white/5 grid md:grid-cols-3 gap-12 text-left">
                <div>
                  <h4 className="text-xs uppercase tracking-widest text-accent mb-4">
                    Profiles
                  </h4>
